...
var Presence = styled_components_1.default.span(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  position: absolute;\n  right: -3px;\n  bottom: -3px;\n  width: 11px;\n  height: 11px;\n  border-radius: 50%;\n  z-index: 2;\n  background-color: ", ";\n  border: 2px solid ", ";\n  font-family: -apple-system, BlinkMacSystemFont,\n  \"Segoe UI\", \"Roboto\", \"Oxygen\",\n  \"Ubuntu\", \"Cantarell\", \"Fira Sans\",\n  \"Droid Sans\", \"Helvetica Neue\", sans-serif;\n"], ["\n  position: absolute;\n  right: -3px;\n  bottom: -3px;\n  width: 11px;\n  height: 11px;\n  border-radius: 50%;\n  z-index: 2;\n  background-color: ", ";\n  border: 2px solid ", ";\n  font-family: -apple-system, BlinkMacSystemFont,\n  \"Segoe UI\", \"Roboto\", \"Oxygen\",\n  \"Ubuntu\", \"Cantarell\", \"Fira Sans\",\n  \"Droid Sans\", \"Helvetica Neue\", sans-serif;\n"])), function (props) { return (props.presence == "online" ? "#36C5AB" : "#FD9A00"); }, function (props) { return (props.dark ? "#08111d" : "#ffffff"); });
...
exports.AvatarComponent = function (props) {
    ...
    return (React.createElement(Container, { width: width, height: height, onMouseEnter: function () { return setOver(true); }, onMouseLeave: function () { return setOver(false); } },
...
exports.Avatar = React.memo(function (props) { return React.createElement(exports.AvatarComponent, __assign({}, props)); });
