...
exports.Avatar = function (props) {
    ...
    var _b = react_1.useState(false), online = _b[0], setOnline = _b[1];
    var _c = react_1.useState(false), offline = _c[0], setOffline = _c[1];
    ...
    return (React.createElement(Container, { onMouseEnter: function () { return setOver(true); }, onMouseLeave: function () { return setOver(false); } },
        ...
        props.heartbeat && !offline &&
            React.createElement(Badge, { online: online, dark: props.dark || false }),
