...
const Muted = styled_components_1.default.span `
  ...
  border-radius: ${props => props.borderRadius}px;
`;
const InnerMemo = React.memo((props) => React.createElement(Inner, Object.assign({}, props), props.children));
/**
