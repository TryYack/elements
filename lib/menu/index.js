...
var AvatarContainer = styled_components_1.default.div(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  margin-right: 7px;\n  margin-left: 3px;\n"], ["\n  margin-right: 7px;\n  margin-left: 3px;\n"])));
var Text = styled_components_1.default.div(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  overflow: hidden;\n  font-size: 14px;\n  font-family: -apple-system, BlinkMacSystemFont,\n  \"Segoe UI\", \"Roboto\", \"Oxygen\",\n  \"Ubuntu\", \"Cantarell\", \"Fira Sans\",\n  \"Droid Sans\", \"Helvetica Neue\", sans-serif;\n  font-weight: 400;\n  color: #868e96;\n  width: 100%;\n  white-space: nowrap;\n"], ["\n  overflow: hidden;\n  font-size: 14px;\n  font-family: -apple-system, BlinkMacSystemFont,\n  \"Segoe UI\", \"Roboto\", \"Oxygen\",\n  \"Ubuntu\", \"Cantarell\", \"Fira Sans\",\n  \"Droid Sans\", \"Helvetica Neue\", sans-serif;\n  font-weight: 400;\n  color: #868e96;\n  width: 100%;\n  white-space: nowrap;\n"])));
var TextContainer = styled_components_1.default.div(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  align-items: flex-start;\n  align-content: flex-start;\n  justify-content: flex-start;\n  position: relative;\n"], ["\n  display: flex;\n  flex-direction: column;\n  align-items: flex-start;\n  align-content: flex-start;\n  justify-content: flex-start;\n  position: relative;\n"])));
    ...
    return (React.createElement(Container, null,
        React.createElement(ContainerPadding, null, props.items.map(function (item, index) {
            ...
            return (React.createElement(RowContainer, { key: index },
                React.createElement(Row, { onClick: item.onClick, nohover: item.divider },
