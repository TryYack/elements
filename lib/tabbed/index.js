    ...
    return (React.createElement(PanelContainer, null,
        React.createElement(PanelTitles, { size: props.size || "default" },
            props.panels.map((panel, index) => {
                if (!panel.show)
                    return null;
                return (React.createElement(PanelTabButton, { borderless: props.borderless || false, active: current == index, size: props.size || "default", key: index, className: current == index ? "active" : "", onClick: () => setCurrent(index) },
