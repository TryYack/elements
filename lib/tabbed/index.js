...
exports.Tabbed = function (props) {
    ...
    return (React.createElement(PanelContainer, { current: current, className: "tabbed-component" },
        React.createElement(PanelTitles, { className: "tab" }, props.panels.map(function (panel, index) {
            if (!panel.show)
                return null;
