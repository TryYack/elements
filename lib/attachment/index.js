...
const AttachmentComponent = (props) => {
    ...
    const getMimeTypeIcon = (type) => {
        switch (type.split("/")[0]) {
            case "audio": return (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: 25, height: 25, viewBox: "0 0 24 24", style: { fill: "white", transform: ";-ms-filter:" } },
                React.createElement("path", { d: "M16,12V6c0-2.217-1.785-4.021-3.979-4.021c-0.069,0-0.14,0.009-0.209,0.025C9.693,2.104,8,3.857,8,6v6c0,2.206,1.794,4,4,4 S16,14.206,16,12z M10,12V6c0-1.103,0.897-2,2-2c0.055,0,0.109-0.005,0.163-0.015C13.188,4.06,14,4.935,14,6v6c0,1.103-0.897,2-2,2 S10,13.103,10,12z" }),
                React.createElement("path", { d: "M6,12H4c0,4.072,3.061,7.436,7,7.931V22h2v-2.069c3.939-0.495,7-3.858,7-7.931h-2c0,3.309-2.691,6-6,6S6,15.309,6,12z" })));
            case "application": return (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: 25, height: 25, viewBox: "0 0 24 24", style: { fill: "white", transform: ";-ms-filter:" } },
                React.createElement("path", { fill: "none", d: "M4 15v4h16.002L20 15H4zM16 18h-2v-2h2V18zM19 18h-2v-2h2V18zM4 5v4h16.002L20 5H4zM16 8h-2V6h2V8zM19 8h-2V6h2V8z" }),
                React.createElement("path", { d: "M20 3H4C2.897 3 2 3.897 2 5v4c0 1.103.897 2 2 2h16c1.103 0 2-.897 2-2V5C22 3.897 21.103 3 20 3zM4 9V5h16l.002 4H4zM20 13H4c-1.103 0-2 .897-2 2v4c0 1.103.897 2 2 2h16c1.103 0 2-.897 2-2v-4C22 13.897 21.103 13 20 13zM4 19v-4h16l.002 4H4z" }),
                React.createElement("path", { d: "M17 6H19V8H17zM14 6H16V8H14zM17 16H19V18H17zM14 16H16V18H14z" })));
            case "video": return (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: 25, height: 25, viewBox: "0 0 24 24", style: { fill: "white", transform: ";-ms-filter:" } },
                React.createElement("path", { d: "M16,12V6c0-2.217-1.785-4.021-3.979-4.021c-0.069,0-0.14,0.009-0.209,0.025C9.693,2.104,8,3.857,8,6v6c0,2.206,1.794,4,4,4 S16,14.206,16,12z M10,12V6c0-1.103,0.897-2,2-2c0.055,0,0.109-0.005,0.163-0.015C13.188,4.06,14,4.935,14,6v6c0,1.103-0.897,2-2,2 S10,13.103,10,12z" }),
                React.createElement("path", { d: "M6,12H4c0,4.072,3.061,7.436,7,7.931V22h2v-2.069c3.939-0.495,7-3.858,7-7.931h-2c0,3.309-2.691,6-6,6S6,15.309,6,12z" })));
            case "image": return (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: 25, height: 25, viewBox: "0 0 24 24", style: { fill: "white", transform: ";-ms-filter:" } },
                React.createElement("circle", { cx: "7.499", cy: "9.5", r: "1.5" }),
                React.createElement("path", { d: "M10.499 14L8.999 12 5.999 16 8.999 16 11.999 16 17.999 16 13.499 10z" }),
                React.createElement("path", { d: "M19.999,4h-16c-1.103,0-2,0.897-2,2v12c0,1.103,0.897,2,2,2h16c1.103,0,2-0.897,2-2V6C21.999,4.897,21.102,4,19.999,4z M3.999,18V6h16l0.002,12H3.999z" })));
            case "text": return (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: 25, height: 25, viewBox: "0 0 24 24", style: { fill: "white", transform: ";-ms-filter:" } },
                React.createElement("path", { d: "M11.307,4l-6,16h2.137l1.875-5h6.363l1.875,5h2.137l-6-16H11.307z M10.068,13L12.5,6.515L14.932,13H10.068z" })));
            default: return (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: 25, height: 25, viewBox: "0 0 24 24", style: { fill: "white", transform: ";-ms-filter:" } },
                React.createElement("path", { d: "M12.186,14.552c-0.617,0-0.977,0.587-0.977,1.373c0,0.791,0.371,1.35,0.983,1.35 c0.617,0,0.971-0.588,0.971-1.374C13.163,15.175,12.815,14.552,12.186,14.552z" }),
                React.createElement("path", { d: "M14,2H6C4.896,2,4,2.896,4,4v16c0,1.104,0.896,2,2,2h12c1.104,0,2-0.896,2-2V8L14,2z M9.155,17.454 c-0.426,0.354-1.073,0.521-1.864,0.521c-0.475,0-0.81-0.03-1.038-0.06v-3.971c0.336-0.054,0.773-0.083,1.235-0.083 c0.768,0,1.266,0.138,1.655,0.432c0.42,0.312,0.684,0.81,0.684,1.522C9.827,16.59,9.545,17.124,9.155,17.454z M12.145,18 c-1.2,0-1.901-0.906-1.901-2.058c0-1.211,0.773-2.116,1.967-2.116c1.241,0,1.919,0.929,1.919,2.045 C14.129,17.196,13.325,18,12.145,18z M16.8,17.238c0.275,0,0.581-0.061,0.762-0.132l0.138,0.713 c-0.168,0.084-0.546,0.174-1.037,0.174c-1.397,0-2.117-0.869-2.117-2.021c0-1.379,0.983-2.146,2.207-2.146 c0.474,0,0.833,0.096,0.995,0.18l-0.186,0.726c-0.187-0.078-0.444-0.15-0.768-0.15c-0.726,0-1.29,0.438-1.29,1.338 C15.504,16.729,15.984,17.238,16.8,17.238z M14,9c-0.553,0-1,0-1,0V4l5,5H14z" }),
                React.createElement("path", { d: "M7.584,14.563c-0.203,0-0.335,0.018-0.413,0.036v2.645c0.078,0.018,0.204,0.018,0.317,0.018 c0.828,0.006,1.367-0.449,1.367-1.415C8.861,15.007,8.37,14.563,7.584,14.563z" })));
        }
    };
    ...
    const Preview = () => {
        if (mimeType(props.mime) == "image" && props.preview) {
            return React.createElement("img", { src: props.preview, width: "100%", height: "auto" });
        }
    ...
    // prettier-ignore
    return (React.createElement(Container, { preview: props.preview, fullwidth: props.fullwidth || false },
        React.createElement(Preview, null),
        (props.onDeleteClick) &&
            React.createElement(CloseButton, { onClick: props.onDeleteClick },
                React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "17", height: "17", viewBox: "0 0 24 24", style: { fill: "#acb5bd", transform: ";-ms-filter:" } },
        ...
        React.createElement(ContainerRow, null,
            ...
            React.createElement(Content, null,
                ...
                props.size && React.createElement(Size, null, bytesToSize(props.size)),
                React.createElement(Info, null,
                    React.createElement(Extension, null, getMimeTypeDescription(props.mime)),
                    React.createElement(Link, { onClick: () => window.open(props.uri) }, "Download"),
                    (props.onPreviewClick && props.preview) &&
                        React.createElement(Link, { onClick: props.onPreviewClick }, "Preview"))))));
};
