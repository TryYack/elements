...
exports.Attachment = function (props) {
    ...
    return (React.createElement(Container, null,
        React.createElement(Icon, { color: getMimeTypeColor(props.mime), className: "row justify-content-center" }, getMimeTypeIcon(props.mime)),
        React.createElement(Content, null,
            ...
            React.createElement(Info, null,
                ...
                React.createElement(Link, { className: "button", onClick: props.onDownloadClick }, "Download"),
