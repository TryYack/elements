...
const AttachmentComponent = (props) => {
    ...
    const getMimeTypeIcon = (type) => {
        switch (type.split("/")[0]) {
            case "audio": return React.createElement(react_feather_6.Activity, { color: "white", size: 25, thickness: "1" });
            case "application": return React.createElement(react_feather_5.File, { color: "white", size: 25, thickness: "1" });
            case "video": return React.createElement(react_feather_2.Video, { color: "white", size: 25, thickness: "1" });
            case "text": return React.createElement(react_feather_4.AlignLeft, { color: "white", size: 25, thickness: "1" });
            case "image": return React.createElement(react_feather_1.Image, { color: "white", size: 25, thickness: "1" });
            case "font": return React.createElement(react_feather_3.Download, { color: "white", size: 25, thickness: "1" });
            default: return React.createElement(react_feather_5.File, { color: "white", size: 25, thickness: "1" });
        }
    };
