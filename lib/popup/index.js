...
var Popup = /** @class */ (function (_super) {
    ...
    Popup.prototype.render = function () {
        ...
        var rectangle = this.rootRef.getBoundingClientRect ? this.rootRef.getBoundingClientRect() : null;
        var top = rectangle ? rectangle.top : 0;
        var left = rectangle ? rectangle.left : 0;
        var width = rectangle ? rectangle.width : 0;
        var height = rectangle ? rectangle.height : 0;
        var className = this.props.containerClassName ? this.props.containerClassName : "";
        // prettier-ignore
        return (React.createElement(Container, { className: className, ref: function (ref) { return _this.rootRef = ref; } },
            this.props.children,
            this.props.visible &&
                React.createElement("div", { style: { top: top, left: left, width: width, height: height, position: "absolute" } },
